...
private:
  ...
  static constexpr double kp_[2]           = {42.5, 8.0}; // 比例ゲイン(xy,rotate)
  static constexpr double ki_[2]           = {10.5, 6.2}; // 積分ゲイン(xy,rotate)
  static constexpr double kd_[2]           = {0.03, 0.01}; // 微分ゲイン(xy,rotate)
  static constexpr double maxVelocity_     = 5000.0;     // 最大速度
  static constexpr double maxAcceleration_ = 4000.0;     // 最大加速度
  static constexpr double minAcceleration_ = 750.0;      // 最小加速度
  static constexpr double reachSpeed_      = 250.0;     // 加速度上昇の速さ
